export default class Partido {
   ...
   * @param {string} fecha - Fecha en la que se jugara el partido (formato: DIA, DD/MM).
  ...
  /**
   * En caso de ser una cantidad valida, cambia la prediccion realizada por el usuario de los goles
